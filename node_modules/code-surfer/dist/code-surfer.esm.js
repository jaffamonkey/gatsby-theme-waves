...
import { useDeck, useSteps as useSteps$1, Notes, useTheme, Slide, Zoom, Clock } from 'mdx-deck';
...
function useSpring(_ref) {
  ...
  var _useState2 = useState(target),
      value = _useState2[0],
...
function CodeSurferLayout(_ref) {
  ...
  var deck = useDeck();
  var steps = React.useMemo(getStepsFromChildren(children), [deck.index]);
...
function getColumnsFromChildren(children, sizes) {
  ...
  stepElements.forEach(function (stepElement, stepIndex) {
    React.Children.toArray(stepElement.props.children).filter(function (element) {
      return element.type !== Notes;
...
function MobilePresenter(_ref3) {
  ...
  return React.createElement("div", {
    ...
    styles: css(_templateObject(), deckHeight)
  }), React.createElement("div", {
    style: {
      height: deckHeight
    }
...
function DesktopPresenter(_ref4) {
  ...
  }, React.createElement("pre", null, "Slide ", index + 1, " of ", slides.length), React.createElement(Clock, null)), React.createElement("a", {
    target: "_blank",
  ...
  }, "Open Slides in New Window")), React.createElement("div", {
    style: {
      height: "100%",
      boxSizing: "border-box"
    }
...
var Presenter = function Presenter(props) {
  ...
  var allNotes = React.useMemo(function () {
  ...
  return React.createElement(React.Fragment, null, !areNotesReady && // Need to render all slides to run the effects that set the notes
  React.createElement(AllSlides, {
    ...
    context: props,
    slides: slides
  }), windowWidth > 700 ? React.createElement(DesktopPresenter, Object.assign({}, {
    allNotes: allNotes,
    index: index,
    slides: slides,
    noteIndex: noteIndex,
    children: children
  })) : React.createElement(MobilePresenter, Object.assign({}, {
    allNotes: allNotes,
    index: index,
    slides: slides,
    noteIndex: noteIndex,
...
function useWindowWidth() {
  var _React$useState3 = React.useState(window && window.innerWidth),
...
export { Code, columnLayout as CodeSurferColumnLayout, layout as CodeSurferLayout, Step, dracula, draculaPartial, duotoneDark, duotoneDarkPartial, duotoneLight, duotoneLightPartial, github, githubPartial, nightOwl, nightOwlPartial, oceanicNext, oceanicNextPartial, shadesOfPurple, shadesOfPurplePartial, ultramin, ultraminPartial, vsDark, vsDarkPartial };
