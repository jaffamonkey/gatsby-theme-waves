...
Half my career has been in `QA` and `Test management`(RIP), the latter half focused on `Test engineering` and `DevOps`. Although the skills most frequnekly utilised are my technical skills, I also bring a Quality assurance mindset.

I have provided Quality assurance and Test engineering services to over 50 companies. These ranged from groundbreaking startups to companies in stages of chaos. 
...
### I will not judge your team or company, and take pride in bringing better quality to web and mobile apps._
