...
####
> **_When building and maintaining a test framework it should always be optimal - no clunk, clutter or useless tests_**
...
_Choose tools that do not add too much overhead  on the `Build server`, as ideally it should run 
