...
--- 
What an Agile coach/consultant does, was always covered in Quality assurance remit (without the Lego, and bug-hunt fun days). (Software) quality assurance means monitoring the methods and approaches used in producing softare, to ensure quality. Even if you just need a days review, you will be surprised how many improvements can be made.
<CodeWave>
