...
Firstly: Focus on tasks, not roles - surprisingly how quickly most most assumption on an individual based on assigned role.

Secondly: Humans make mistakes, get upset, get stressed - and these are things easy to alleviate, but not with meetings and process.
