...
const Posts = ({ location, posts, siteTitle, socialLinks }) => (
  <Layout location={location} title={siteTitle}>
    ...
    <br />
    <Styled.div><a href="http://jaffamonkey.com/whoihavehelped"><img Hspace="5" width="45" src="./images/clients/nike.jpg" alt="Nike" /><img Hspace="5" width="45" src="./images/clients/tele2.jpg" alt="Nike" />
